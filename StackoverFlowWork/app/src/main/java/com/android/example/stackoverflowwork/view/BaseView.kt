package com.android.example.stackoverflowwork.view
        ...
        attrs.let {
            ...
            if (emptyViewResId != -1) {
                ...
                if (emptyViewResId == R.layout.layout_empty) {
                    ...
                    this.textOfEmptyView = a.getString(R.styleable.BaseView_textOfEmptyView) ?:"Belirtilen isimde bir kullanıcı bulunamadı."
